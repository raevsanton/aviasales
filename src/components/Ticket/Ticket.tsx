...
export default class Ticket extends React.Component<any> {
    render() {
        const { price, carrier, originFrom, destinationFrom, dateFrom, stopsFrom, 
        durationFrom, originTo, destinationTo, dateTo, stopsTo, durationTo } = this.props.ticket;
        //Price
